...
extern const bfd_target bfd_elf32_mtsparc_vec;
...
extern const bfd_target bfd_elf64_mtsparc_vec;
...
extern const bfd_target ecoffmtalpha_little_vec;
...
extern const bfd_target mtsparclinux_vec;
